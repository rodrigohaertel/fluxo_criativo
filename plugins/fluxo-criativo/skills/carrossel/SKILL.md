...
6. **Execução conforme escolha** (seção 3.5 do `passo-output-triplo.md`). Manual = nada extra; Chrome = abre via MCP e roda os 6 prompts; API = `${CLAUDE_PLUGIN_ROOT}/scripts/gerar-imagens-api.py` em paralelo gerando 6 PNGs.
