...
```
python3 ${CLAUDE_PLUGIN_ROOT}/scripts/painel-incremental.py --secao quadro
```
...
```
python3 ${CLAUDE_PLUGIN_ROOT}/scripts/painel-incremental.py --secao pesquisa
```
...
```
python3 ${CLAUDE_PLUGIN_ROOT}/scripts/painel-atualizar.py
```
